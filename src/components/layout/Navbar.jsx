...
export default function Navbar() {
  ...
  return (
    <nav className={`flex items-center justify-between px-6 fixed w-full top-0 z-50 transition-all duration-300 bg-brand-black border-b border-white/5 ${scrolled ? 'shadow-2xl py-4' : 'py-6'}`}>
