...
export default function FinalCTA() {
  return (
    <section className="bg-electric py-24 px-6 text-center">
      ...
      <Link to="/contact" className="px-10 py-4 bg-brand-black text-electric font-bold rounded-full text-lg shadow-xl hover:scale-105 transition-transform inline-flex items-center gap-2">
